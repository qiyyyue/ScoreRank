...
CREATE TABLE `student_info` (
  ...
  `continent` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `country` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `city` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `student_number` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `birthday` date DEFAULT NULL,
  `CI` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `student_name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
...
-- Dump completed on 2018-11-07  1:48:59
